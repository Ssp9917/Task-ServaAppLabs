            ...
            <tbody className="" key={i}>
              <tr className="bg-gray-50 border-b  dark:border-gray-700">
                ...
                >
                  <img
                    className="w-16"
                    src={API_BASE_URL + imageBaseUrl + d.image}
                    alt="img"
                  />
                </th>
                <td className="px-6 py-4 text-black ">{d.name}</td>
                <td className="px-6 py-4 text-black ">₹{d.price}</td>
                  ...
                  <div className=" flex gap-2">
                    <div className=" flex gap-2 cursor-pointer text-black ">
                      ...
                      >
                        ...
                        <div
                          onClick={() => {
                            navigator("/admin/editProduct/" + d._id);
                          }}
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
